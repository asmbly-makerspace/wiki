...
log "  2. Validate the instance (Step 6 in README)"
log "  3. Move the Elastic IP to this instance and confirm DNS resolves here"
log "  4. Run setup-ssl.sh to obtain the Let's Encrypt certificate"
log "  5. Test Discourse SSO login end-to-end (PluggableAuth v7 API changed)"
log "  6. Verify Scribunto templates render correctly"
